...
def upgrade():
    ...
    sa.Column('action_detail', postgresql.JSON(), nullable=True),
    ...
    op.add_column(u'stage', sa.Column('post_opportunities', sa.Boolean(), nullable=False, server_default=sa.schema.DefaultClause('false')))
    op.add_column(u'stage', sa.Column('send_notifs', sa.Boolean(), nullable=False, server_default=sa.schema.DefaultClause('false')))
...
def downgrade():
    ...
    op.drop_column(u'stage', 'post_opportunities')
