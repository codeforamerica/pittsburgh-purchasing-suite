...
Revision ID: 42bce3132048
Revises: 27c899412dc7
Create Date: 2015-07-24 17:30:04.168874

"""

# revision identifiers, used by Alembic.
revision = '42bce3132048'
...
def upgrade():
    ...
    op.add_column(u'opportunity', sa.Column('planned_advertise', sa.DateTime(), nullable=True))
