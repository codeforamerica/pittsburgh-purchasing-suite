...
def upgrade():
    ...
    op.add_column('vendor', sa.Column('unsubscribed_from_newsletter', sa.Boolean(), nullable=False, server_default=sa.schema.DefaultClause('false')))
...
def downgrade():
    ### commands auto generated by Alembic - please adjust! ###
    op.drop_column('vendor', 'unsubscribed_from_newsletter')
